...
use mapi_proto::{
    Connected, FolderEntryId, FolderId, LogonResponse, LongTermId, ObjectHandle, PropertySet,
    PropertyValue, RopBatch, RopResponse, SPECIAL_FOLDER_PROPERTIES, ShortTermId, SpecialFolder,
    WellKnownFolder,
};
